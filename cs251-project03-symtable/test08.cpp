...
// 	REQUIRE(table.lookup("ee", symbol, symtable<string, string>::ScopeOption::GLOBAL));
// 	REQUIRE(symbol == "double");
	REQUIRE(table.lookup("ee", symbol, symtable<string, string>::ScopeOption::ALL));
	REQUIRE(symbol == "double");
	REQUIRE(table.lookup("ee", symbol, symtable<string, string>::ScopeOption::CURRENT));
	REQUIRE(symbol == "double");
